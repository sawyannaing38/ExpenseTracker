...
let monthlyExpenseLists = [];

// const variables
const soruces = ["rent", "food", "electricBill", "waterBill", "phoneBill", "educationBill"];
...
continueBtn.addEventListener("click", function() 
{
    ...
    localStorage.setItem("monthlyExpense", JSON.stringify(monthlyExpenseLists));
...
continueAnywayBtn.addEventListener("click", function() 
{
    ...
    if (monthlyExpenseLists.length > 0)
    {
                ...
                <div class="source-container">
                    ...
                    <select name="source${number}" id="source${number}" class="source${number}">
                        ...
                        <optgroup label="souce-lists">
                            ...
                            <option value="educationBill">Education Bill</option>
                        </optgroup>
                    </select>
                </div>
            </div>
